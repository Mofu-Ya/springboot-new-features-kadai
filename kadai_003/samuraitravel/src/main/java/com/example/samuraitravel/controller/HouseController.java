...
public class HouseController {
	...
	public HouseController(HouseRepository houseRepository, ReviewRepository reviewRepository, UserRepository userRepository, ReviewService reviewService, FavoriteService favoriteService) {
	...
	public String show(@PathVariable(name = "id") Integer id, @AuthenticationPrincipal UserDetailsImpl userDetailsImpl, Model model) {
		...
		List<Review> reviews = reviewRepository.findTop10ByHouseOrderByCreatedAtDesc(house);
